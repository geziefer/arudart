...
- [ ] 1. Create event dataclasses and state enum
...
- [ ] 2. Implement DartTracker class
  - [ ] 2.1 Create `src/state_machine/dart_tracker.py` with DartTracker class
  ...
  - [ ] 2.2 Write property test for dart count invariant
  ...
  - [ ] 2.3 Write unit tests for DartTracker
...
- [ ] 3. Implement MotionClassifier class
  - [ ] 3.1 Create `src/state_machine/motion_classifier.py` with MotionClassifier class
  ...
  - [ ] 3.2 Write property test for motion classification
  ...
  - [ ] 3.3 Write unit tests for MotionClassifier
...
- [ ] 4. Implement ThrowStateMachine class (core logic)
  - [ ] 4.1 Create `src/state_machine/throw_state_machine.py` with ThrowStateMachine class
  ...
  - [ ] 4.2 Implement handle_wait_for_throw() method
  ...
  - [ ] 4.3 Implement handle_throw_detected() method
  ...
  - [ ] 4.6 Write property test for state transition correctness
  ...
  - [ ] 4.7 Write unit tests for state machine
...
- [ ] 6. Integrate state machine into main.py
  - [ ] 6.1 Replace simple motion state tracking with ThrowStateMachine
